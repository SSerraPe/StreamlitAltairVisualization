...
En caso de dificultades para ejecutar localmente el Streamlit, el dashboard está disponible públicamente en la plataforma [Streamlit Community Cloud](https://streamlit.io/). El enlace se encuentra adjunto en la plataforma de entrega.
